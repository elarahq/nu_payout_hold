...
FEATURE_TABLE_NAME = 'data_science_metastore.nu_payout_production_tables.ONE_TIME_FINAL_KAFKA_NU_DATA'
...
result_df.write.format("delta").mode("overwrite").option("overwriteSchema", "true").saveAsTable("data_science_metastore.nu_payout_production_tables.MAIN_PROD_LATEST_GA_ID_KAFKA_NU_DATA")
